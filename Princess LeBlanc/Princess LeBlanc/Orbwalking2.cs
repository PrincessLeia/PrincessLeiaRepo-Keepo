...
namespace Princess_LeBlanc
{
    ...
    public static class Orbwalking2
    {
        ...
        /// </summary>
        public static void Orbwalk2(AttackableUnit target,
            Vector3 position,
        ...
        public class Orbwalker2
        {
            ...
            public Orbwalker2(Menu attachToMenu)
            {
                ...
                drawings.AddItem(
                    new MenuItem("AACircle", "AACircle").SetShared()
                        .SetValue(new Circle(true, Color.FloralWhite)));
                drawings.AddItem(
                    new MenuItem("AACircle2", "Enemy AA circle").SetShared()
                        .SetValue(new Circle(false, Color.FloralWhite)));
                drawings.AddItem(

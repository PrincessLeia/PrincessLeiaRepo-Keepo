...
namespace Prince_Urgot
{
    internal class MenuHandler
    {
        ...
        public static void Init()
        {
            ...
            lastHitMenu.AddItem(
                new MenuItem("lastHitQManaPercent", "Minimum Q Mana Percent").SetValue(new Slider(30, 0, 100)));
            ...
            itemsMenu.AddItem(
                new MenuItem("useMura", "enable Auto Muramana").SetValue(new KeyBind('A', KeyBindType.Toggle)));
            ...
            drawMenu.AddItem(
                new MenuItem("drawQ", "Draw Q").SetValue(new Circle(true, Color.FromArgb(100, Color.Aqua))));
            drawMenu.AddItem(
                new MenuItem("drawEe", "Draw E").SetValue(new Circle(true, Color.FromArgb(100, Color.Aqua))));
            drawMenu.AddItem(
                new MenuItem("drawE", "Draw extended Q range if hit by E").SetValue(
                    new Circle(true, Color.FromArgb(100, Color.Aqua))));

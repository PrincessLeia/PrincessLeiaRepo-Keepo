    ...
    internal class DrawingHandler
    {
        ...
        public static void OnDraw(EventArgs args)
        {
            ...
            if (MenuHandler._uMenu.Item("HUD").GetValue<bool>())
            {
                ...
                {
                    Drawing.DrawText(Drawing.Width * 0.90f, Drawing.Height * 0.60f, Color.Yellow, "Q LastHit : On");
                }
                else
                {
                    Drawing.DrawText(Drawing.Width * 0.90f, Drawing.Height * 0.60f, Color.DarkRed, "Q LastHit : Off");
                }

                if (MenuHandler._uMenu.Item("LaneClearQ").GetValue<bool>() ||
                    MenuHandler._uMenu.Item("LaneClearE").GetValue<bool>())
                {
                    Drawing.DrawText(Drawing.Width * 0.90f, Drawing.Height * 0.58f, Color.Yellow, "Q LaneClear : On");
                }
                else
                {
                    Drawing.DrawText(Drawing.Width * 0.90f, Drawing.Height * 0.58f, Color.DarkRed, "Q LaneClear : Off");
                }
                ...
                if (ItemHandler.Muramana.IsReady())
                {
                    ...
                    {
                        Drawing.DrawText(
                            Drawing.Width * 0.90f, Drawing.Height * 0.64f, Color.Yellow, "Auto Muramana : On");
                    }
                    else
                    {
                        Drawing.DrawText(
                            Drawing.Width * 0.90f, Drawing.Height * 0.64f, Color.DarkRed, "Auto Muramana : Off");
                    }
                }
                else
                {
                    Drawing.DrawText(
                        Drawing.Width * 0.90f, Drawing.Height * 0.64f, Color.DarkRed, "Muramana unavailable");
                }
            }

            if (MenuHandler._uMenu.Item("autoR").GetValue<bool>() || MenuHandler._uMenu.Item("autoInt").GetValue<bool>())
            {
                Drawing.DrawText(Drawing.Width * 0.90f, Drawing.Height * 0.62f, Color.Yellow, "Auto R : On");
            }
            else
            {
                Drawing.DrawText(Drawing.Width * 0.90f, Drawing.Height * 0.62f, Color.DarkRed, "Auto R : Off");
            }

            if (MenuHandler._uMenu.Item("hitbye").GetValue<bool>())
            {

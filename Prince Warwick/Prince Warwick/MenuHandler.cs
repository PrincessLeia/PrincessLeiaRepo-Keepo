...
namespace Prince_Warwick
{
    class MenuHandler
    {
        ...
        WarwickConfig.SubMenu("Drawing").AddItem(new MenuItem("drawQ", "Draw Q").SetValue(new Circle(true, Color.FromArgb(100, Color.Aqua))));
        WarwickConfig.SubMenu("Drawing").AddItem(new MenuItem("drawE", "Draw E passive").SetValue(new Circle(true, Color.FromArgb(100, Color.Aqua))));
        WarwickConfig.SubMenu("Drawing").AddItem(new MenuItem("drawR", "Draw R").SetValue(new Circle(true, Color.FromArgb(100, Color.Aqua))));
        WarwickConfig.SubMenu("Drawing").AddItem(new MenuItem("drawQss", "Draw if Target has QSS").SetValue(new Circle(true, Color.FromArgb(100, Color.Red))));

        WarwickConfig.AddSubMenu(new Menu("Misc", "Misc"));
        WarwickConfig.SubMenu("Misc").AddItem(new MenuItem("autoULT", "ULT on LeftClick").SetValue(new KeyBind('T', KeyBindType.Toggle)));
